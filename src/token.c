...
int token_collect(Tokeniser *self) {
    for (;;) {
        ...
        case '>': create_token(self, TokenGt, EMPTY_STRING, position); continue;
        case '{': create_token(self, TokenLCurly, EMPTY_STRING, position); continue;
        case '[': create_token(self, TokenLBrack, EMPTY_STRING, position); continue;
        case '(': create_token(self, TokenLParen, EMPTY_STRING, position); continue;
        case '&': create_token(self, TokenAmpersand, EMPTY_STRING, position); continue;
        case '|': create_token(self, TokenBar, EMPTY_STRING, position); continue;
        case '<': create_token(self, TokenLt, EMPTY_STRING, position); continue;
        case '-': create_token(self, TokenMinus, EMPTY_STRING, position); continue;
        case '!': create_token(self, TokenExclamation, EMPTY_STRING, position); continue;
        case '+': create_token(self, TokenPlus, EMPTY_STRING, position); continue;
        case '}': create_token(self, TokenRCurly, EMPTY_STRING, position); continue;
        case ']': create_token(self, TokenRBrack, EMPTY_STRING, position); continue;
        case ')': create_token(self, TokenRParen, EMPTY_STRING, position); continue;
        case ';': create_token(self, TokenSemicolon, EMPTY_STRING, position); continue;
        case '*': create_token(self, TokenStar, EMPTY_STRING, position); continue;
        case '/':
            // Skip comments
            c = peek_char(self);
            if (c == '/') {
            ...
            create_token(self, TokenSlash, EMPTY_STRING, position);
            continue;
        case '0'...'9':
            String number = {0};
            append(&number, c);
            ...
            create_token(self, TokenNumber, number, position);
            continue;
        case '\'':
            String ch = {0};
            ...
            create_token(self, TokenChar, ch, position);
            continue;
        ...
        case '"':
            ...
            create_token(self, TokenString, str, position);
            continue;
        case 'A'...'Z':
        case 'a'...'z':
            String word = {0};
            ...
            create_token(self, kind, word, position);
            continue;
        default:
            return -1;
        }
    ...
    create_token(self, TokenEof, EMPTY_STRING, self->position);

    return 0;
}

void create_token(Tokeniser *self, TokenKind kind, String value, Position position) {
    Token token = {0};
    token.kind = kind;
    token.value = value;
